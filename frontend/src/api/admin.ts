...
export const adminApi = {
  ...
  /** POST /api/admin/users — create a new user account + assign role */
  ...
  /** PUT /api/admin/users/:id/roles — replace user's active role set */
  updateRoles: async (userId: string, payload: UpdateRolesPayload): Promise<AdminUser> => {
    return apiRequest<AdminUser>(apiClient.put(`/api/admin/users/${userId}/roles`, payload));
  },
