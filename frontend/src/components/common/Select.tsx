...
export const Select = React.forwardRef<HTMLDivElement, SelectProps>(
  (
    ...
    // Auto-enable search if there are 6 or more options, unless explicitly controlled
      ...
      <div className={`w-full relative ${className}`} ref={containerRef}>
        ...
        >
          ...
          <div className="flex items-center gap-1 shrink-0 text-slate-400">
            {selectedOption && placeholder && String(value) !== '' && !required && (
              <span
                role="button"
                onClick={(e) => {
                  e.stopPropagation();
            ...
            <div className="overflow-y-auto py-1 max-h-48 divide-y divide-slate-50 dark:divide-slate-800/50">
              ...
              {placeholder && (
                <button
                  ...
                  onClick={() => !disablePlaceholder && handleSelect('')}
                ...
                >
                  ...
                  {String(value) === '' && <Check className="w-3.5 h-3.5 text-indigo-600" />}
                </button>
              )}
