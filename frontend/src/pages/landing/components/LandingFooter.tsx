...
export const LandingFooter: React.FC = () => {
  ...
  return (
    <footer className="border-t border-white/10 bg-slate-950 py-12 relative z-10 text-xs text-slate-400">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-8 border-b border-white/10">
          ...
          <div className="flex flex-col items-center md:items-start gap-1">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-base text-white">PeoplePay360</span>
            </div>
            <p className="text-slate-400 mt-1 font-medium">Workforce management, simplified.</p>
          </div>
