      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 relative">
            ...
            <div className="relative rounded-2xl sm:rounded-3xl bg-slate-900/90 border border-white/15 p-5 sm:p-6 backdrop-blur-2xl shadow-2xl space-y-4">
              {/* Window Header Badge */}
              <div className="flex items-center justify-between pb-3 border-b border-white/10">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-mono text-slate-400 ml-2">peoplepay360 // overview</span>
                </div>
                <span className="text-[11px] font-medium px-2 py-0.5 rounded-full bg-teal-500/10 text-teal-300 border border-teal-500/20">
                  Live Operations
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                <div className="p-3 rounded-xl bg-white/5 border border-white/10">
                  ...
                  <div className="text-lg font-bold text-white mt-1">128 Active</div>
                </div>
                ...
                <div className="p-3 rounded-xl bg-white/5 border border-white/10">
                  ...
                  <div className="text-lg font-bold text-teal-300 mt-1">98.4% Health</div>
                </div>
                ...
                <div className="col-span-2 sm:col-span-1 p-3 rounded-xl bg-white/5 border border-white/10">
                  ...
                  <div className="text-lg font-bold text-emerald-400 mt-1">Validated</div>
                </div>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-slate-950/60 border border-white/10 space-y-2">
                <div className="flex items-center justify-between text-xs">
                  <span className="font-semibold text-slate-200">Current Payrun Cycle</span>
                  <span className="font-mono text-teal-400 font-bold">BATCH-2026-09</span>
                </div>
                <div className="flex items-center gap-2 pt-1 text-[11px]">
                  <span className="px-2 py-0.5 rounded bg-indigo-600/30 text-indigo-300 font-medium border border-indigo-500/30">1. Draft</span>
                  <span className="text-slate-600">→</span>
                  <span className="px-2 py-0.5 rounded bg-indigo-600/30 text-indigo-300 font-medium border border-indigo-500/30">2. Computed</span>
                  <span className="text-slate-600">→</span>
                  <span className="px-2 py-0.5 rounded bg-teal-500/20 text-teal-300 font-bold border border-teal-500/40 flex items-center gap-1">
              ...
              <div className="p-3.5 rounded-xl bg-white/5 border border-white/10 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-xs font-bold text-white">Monthly Salary Disbursal</div>
                    <div className="text-[11px] text-slate-400">Formula Rule: Standard Engineering (India)</div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-sm font-extrabold text-emerald-400">{formatCurrency(69000)}</div>
                  <div className="text-[10px] text-slate-400">Net Calculated</div>
                </div>
              </div>
