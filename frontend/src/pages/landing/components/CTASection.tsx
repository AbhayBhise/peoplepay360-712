...
export const CTASection: React.FC = () => {
  ...
  return (
    <section className="py-16 sm:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="relative rounded-3xl bg-linear-to-r from-indigo-900/90 via-slate-900 to-teal-950/90 text-white border border-white/15 p-8 sm:p-14 text-center overflow-hidden shadow-2xl backdrop-blur-xl">
        {/* Glow */}
