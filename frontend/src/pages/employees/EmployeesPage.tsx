        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-3">
          ...
          <form onSubmit={handleSearchSubmit} className="sm:col-span-2 relative">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3.5 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-900 focus:bg-white focus:outline-none focus:border-[#714B67] focus:ring-1 focus:ring-[#714B67]"
              />
            </div>
          </form>
          ...
          <div>
            <select
              ...
              className="w-full py-2 px-3 bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-700 focus:bg-white focus:outline-none focus:border-[#714B67]"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {filteredEmployees.map((emp) => (
            <div
              ...
              className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-xs hover:shadow-md hover:border-[#714B67]/40 transition-all cursor-pointer group flex flex-col justify-between"
            >
              <div>
                <div className="flex items-start justify-between gap-2 mb-3">
                  <div className="w-12 h-12 rounded-xl bg-linear-to-tr from-[#714B67] to-[#008784] text-white font-bold text-lg flex items-center justify-center shadow-xs">
                ...
                <h3 className="text-sm font-bold text-slate-900 group-hover:text-[#714B67] transition-colors leading-tight">
                  {emp.name}
                </h3>
              ...
              <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-2xs text-slate-400 font-semibold group-hover:text-[#714B67]">
                  ...
                  >
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-[#714B67] text-white font-bold text-xs flex items-center justify-center shadow-xs">
                          {emp.name.charAt(0).toUpperCase()}
                        </div>
                        <div>
