        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 pb-6 border-b border-slate-100">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-slate-900 text-lg tracking-tight">PeoplePay360</span>
            </div>
            <p className="text-xs text-slate-500 mt-1">Official Payroll Salary Statement</p>
          </div>
          ...
          <div className="text-right">
            ...
            <div className="text-xs text-slate-400 mt-1">Pay Period:</div>
                ...
                {lines.length > 0 ? (
                    ...
                    return (
                      <tr
                        ...
                        className={`hover:bg-slate-50 transition-colors ${
                          isNet ? 'bg-emerald-50/50 font-bold' : ''
                        }`}
                      >
                  ...
                  <>
                    <tr className="hover:bg-slate-50">
                      ...
                      <td className="py-3 px-4 text-right font-mono font-semibold">{formatCurrency(payslip.basic)}</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      ...
                      <td className="py-3 px-4 text-right font-mono text-teal-700 font-semibold">+{formatCurrency(payslip.allowances || 0)}</td>
                    </tr>
                    <tr className="hover:bg-slate-50">
                      ...
                      <td className="py-3 px-4 text-right font-mono text-rose-700 font-semibold">-{formatCurrency(payslip.deductions || 0)}</td>
                    </tr>
                  </>
                )}
              </tbody>
